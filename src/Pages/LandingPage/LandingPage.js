  ...
  return (
    <div className="h-full">
      ...
      <div className="gradient-border">
        <div className="max-w-7xl mx-auto pb-40 pt-10 ">
          ...
          <div className="flex mt-24">
            <div>
              ...
              <button type='button' className=" bg-white p-3 border rounded-2xl text-3xl font-bold mt-4 text-[#0B1547] border-white hover:text-white hover:bg-[#0B1547]">
                Connect
              </button>
            </div>
            <div>
      ...
      <div className="bg-white">
        <div className=" flex flex-col max-w-7xl mx-auto my-32 gap-20">
