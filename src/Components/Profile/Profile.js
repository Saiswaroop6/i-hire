  ...
  return (
    <>
      <div className="flex flex-col gap-6 py-6 mx-auto max-w-7xl">
        {/* row-1 */}
        <div div className="flex w-full border shadow-lg rounded-xl">
            ...
            <div className="flex flex-col items-start gap-4 p-4 border shadow-lg rounded-xl">
              ...
              <div className="flex flex-col gap-1 text-left ">
                ...
                <span>
                  ...
                  such as job posting and applicant tracking, resume screening
                  and filtering, interview scheduling and coordination,
                  candidate assessment and evaluation, and offer management and
                  acceptance. The goal of a hiring system project is to
                  streamline and automate many of the tasks involved in the
                  recruitment and selection process, making it more efficient,
                  objective, and scalable. The system may be designed for use by
                  hiring managers, recruiters, HR professionals, or a
                  combination of these stakeholders, depending on the needs and
              ...
              <div className="flex flex-col gap-1 text-left ">
                ...
                <span className="">
                  ...
                  attendees, vendors, or a combination of these stakeholders.
                  The goal of an event management system project is to
                  streamline and automate many of the tasks involved in
                  organizing an event, making the process more efficient,
                  cost-effective, and enjoyable for everyone involved.
                </span>
              </div>
            </div>
          </div>
      ...
      <ModalDialog open={showModal} maxWidth={"lg"} handleClose={closeModal}>
        ...
        {step === 2 && (
          <AddEducation onSave={closeModal} onCancel={closeModal} />
        )}
        {step === 3 && <AddSkills onSave={closeModal} onCancel={closeModal} />}
      </ModalDialog>
    </>
  );
}
