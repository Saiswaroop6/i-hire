    ...
    <div className="flex flex-col gap-6 py-6 mx-auto max-w-7xl">
      ...
      <div className="flex w-full border shadow-lg rounded-xl">
        <div className="w-48 h-48 m-4 rounded-lg ">
          <img className="rounded-lg" src='https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' alt={"img"}/>
        </div>
