  ...
  return (
    <div className="p-5 border border-solid rounded-lg shadow-lg">
      ...
      <div>
        ...
        <h1 className="font-semibold text-[#004FC1] mt-5">Job Requirements</h1>
        <p>
          Bachelors degree in computer science, software engineering, or similar
          field. Proven work experience as a software test engineer. In-depth
          knowledge of program testing software including Bugzilla and HP
          LoadRunner. Advanced knowledge of debugging codes and software
          development languages. Experience working with popular operating
          systems including Windows and Linux. Strong attention to detail.
          Ability to collate data and compile test reports. Excellent software
          troubleshooting skills. Ability to design and write complex software
          testing procedures.
        </p>
        <h1 className="font-semibold text-[#004FC1] mt-5">
          Background & Skills
      ...
      <p>
        ...
        solutions for renewable energy, such as solar and wind power, as well as
        district-energy infrastructure for cities. Our innovative engineering
        dates back to 1933. Danfoss is family-owned, employing more than 42.000
        people, serving customers in more than 100 countries through a global
        footprint of 95 factories.
      </p>
